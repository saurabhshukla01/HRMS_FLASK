...
CREATE TABLE `announcements` (
  ...
  KEY `announcements_deleted_by_foreign` (`deleted_by`),
  ...
  CONSTRAINT `announcements_deleted_by_foreign` FOREIGN KEY (`deleted_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `announcements_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT
