...
CREATE TABLE `assets` (
  ...
  `discard_date` timestamp NULL DEFAULT NULL,
  ...
  KEY `assets_deleted_by_foreign` (`deleted_by`),
  ...
  CONSTRAINT `assets_deleted_by_foreign` FOREIGN KEY (`deleted_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `assets_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT
