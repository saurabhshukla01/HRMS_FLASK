...
CREATE TABLE `attendance_days` (
  ...
  `total_timesheet_min` int NOT NULL,
  ...
  `unlocked_remark` text COLLATE utf8mb4_unicode_ci,
  ...
  KEY `attendance_days_shift_id_foreign` (`shift_id`),
  KEY `attendance_days_created_by_foreign` (`created_by`),
  KEY `attendance_days_updated_by_foreign` (`updated_by`),
  KEY `attendance_days_deleted_by_foreign` (`deleted_by`),
  CONSTRAINT `attendance_days_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `attendance_days_deleted_by_foreign` FOREIGN KEY (`deleted_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `attendance_days_shift_id_foreign` FOREIGN KEY (`shift_id`) REFERENCES `shifts` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `attendance_days_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `attendance_days_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=66521 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
