...
CREATE TABLE `user_login_activities` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_login_activities_user_id_foreign` (`user_id`),
  CONSTRAINT `user_login_activities_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
