...
CREATE TABLE `activity_logs` (
  ...
  `old_values` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `new_values` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other` text COLLATE utf8mb4_unicode_ci,
  `origin` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `crud` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
