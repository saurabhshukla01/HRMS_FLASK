...
CREATE TABLE `notification_templates` (
  ...
  `document_body` text COLLATE utf8mb4_unicode_ci,
  ...
  KEY `notification_templates_deleted_by_foreign` (`deleted_by`),
  ...
  CONSTRAINT `notification_templates_deleted_by_foreign` FOREIGN KEY (`deleted_by`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
