...
CREATE TABLE `users` (
  ...
  `azure_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `block_login` tinyint(1) DEFAULT NULL,
  `block_login_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `users_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE RESTRICT,
